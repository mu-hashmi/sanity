import type { SanityConfig, SanityScenario } from './config.js'
...
export function createSanityPlan(config: SanityConfig, scenarioName: string): SanityPlan {
...
export function formatDryRunPlan(plan: SanityPlan): string {
